import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, s as spreadAttributes, u as unescapeHTML, e as renderComponent, f as renderHead, d as renderSlot } from '../astro.02098beb.mjs';
/* empty css                                *//* empty css                           */
...
const $$MainHead = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const {
    title = "Lucfreelance",
    description = "Proficient in modern frontend technologies and frameworks such as JAM stack / MERN stack. Also experienced in WordPress design using Elementor, Woocommerce, and more. Besides prompt engineer for cutting-edge advancements"
  } = Astro2.props;
...
}, "/mnt/d/Codes/front/2023/lucfreelance/src/components/MainHead.astro");
...
}, "/mnt/d/Codes/front/2023/lucfreelance/src/components/Icon.astro");
...
` })}`;
}, "/mnt/d/Codes/front/2023/lucfreelance/src/components/ThemeToggle.astro");
...
const $$Nav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const iconLinks = [
    ...
    { label: "Instagram", href: "https://www.instagram.com/lucfreelance/", icon: "instagram-logo" },
    { label: "YouTube", href: "https://www.youtube.com/channel/UCLESWsthGM2vYD22j3aVL4w", icon: "youtube-logo" },
    { label: "X", href: "https://twitter.com/lucfreelance/", icon: "twitter-logo" },
    { label: "GitHub", href: "https://github.com/lucfrelance", icon: "github-logo" }
  ];
...
}, "/mnt/d/Codes/front/2023/lucfreelance/src/components/Nav.astro");
  ...
  return renderTemplate`${maybeRenderHead($$result)}<footer class="astro-SZ7XMLTE">
	<div class="group astro-SZ7XMLTE">
		<p class="astro-SZ7XMLTE">
			${renderComponent($$result, "Icon", $$Icon, { "icon": "rocket-launch", "size": "1.2rem", "class": "astro-SZ7XMLTE" })} Web design by<a href="https://github.com/lucfreelance/" class="astro-SZ7XMLTE">:</a> @lucfreelance ${currentYear} with Withastro frame &copy;</p>
	</div>
	<p class="socials astro-SZ7XMLTE">
		<a href="https://instagram.com/lucfreelance/" class="astro-SZ7XMLTE">Instagram</a>
		<a href="mailto:lucas@lucfreelance.com" class="astro-SZ7XMLTE">Email</a>
		<a href="https://twitter.com/lucfreelance" class="astro-SZ7XMLTE">X</a>
	</p>
</footer>`;
}, "/mnt/d/Codes/front/2023/lucfreelance/src/components/Footer.astro");
...
const $$BaseLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" class="astro-VRZD3FOP">
	<head>
		${renderComponent($$result, "MainHead", $$MainHead, { "title": title, "description": description, "class": "astro-VRZD3FOP" })}
	${renderHead($$result)}</head>
	<body class="astro-VRZD3FOP">
		<div class="stack backgrounds astro-VRZD3FOP">
			${renderComponent($$result, "Nav", $$Nav, { "class": "astro-VRZD3FOP" })}
			${renderSlot($$result, $$slots["default"])}
			${renderComponent($$result, "Footer", $$Footer, { "class": "astro-VRZD3FOP" })}
		</div>
...
}, "/mnt/d/Codes/front/2023/lucfreelance/src/pages/BaseLayout.astro");

const $$file = "/mnt/d/Codes/front/2023/lucfreelance/src/pages/BaseLayout.astro";
const $$url = "/BaseLayout";
...
export { $$BaseLayout as $, BaseLayout as B, $$Icon as a };
